...
const DigitalMoney = ({ language }) => {
    const navigate = useNavigate();
    return (
        <div>
            <section className="text-gray-400 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  body-font">
                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">{language ? "Digital Media Education Course" : "डिजिटल मीडिया शिक्षा पाठ्यक्रम"}
                        </h1>
                        <p className="mb-8 leading-relaxed">{language ? "Women, Men, Students and any other person can earn money by training sitting at home." : "महिला, पुरुष, विद्यार्थी एवं कोई भी व्यक्ति घर बैठे प्रशिक्षण लेकर पैसा कमा सकता है।"}</p>
                        <div className="flex justify-center">
                            <button onClick={() => navigate('/contact')} className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"  >{language ? "Contact Us Now We are available 24/7" : "अभी हमसे संपर्क करें हम 24/7 उपलब्ध हैं"}</button>
                        </div>
                    </div>
                </div>
            </section>
