  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4 w-full">
        <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
          <img className="h-60 rounded w-full object-cover object-center mb-6" src={brvkm} alt="content"/>
          <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">Our Foundation</h3>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4 w-full">
        <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
          <img className="h-40 rounded w-full object-cover object-center mb-6" src={dhamalapp} alt="content"/>
          <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">Our Foundation</h3>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4 w-full">
        <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
          <img className="h-60 rounded w-full object-cover object-center mb-6" src={pura_bazar} alt="content"/>
          <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">Our Foundation</h3>
    ...
    <div className="xl:w-1/4 md:w-1/2 p-4 w-full">
        <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
          <img className="h-60 rounded w-full object-cover object-center mb-6" src={bharovikranti} alt="content"/>
          <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">Our Foundation</h3>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4 w-full">
        <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
          <img className="h-60 rounded w-full object-cover object-center mb-6" src={rajHaveli} alt="content"/>
          <h3 className="tracking-widest text-indigo-400 text-xs font-medium title-font">Our Foundation</h3>
