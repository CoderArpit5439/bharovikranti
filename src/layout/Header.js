              ...
              >
                <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/">{language ? "Home" : "होम"}</Link>
                  </li>
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/services">{language ? "Service" : "सेवाएं"}</Link>
                  </li>
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/products" >{language ? "Product" : "उत्पाद"}</Link>
                  </li>
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/contact" >{language ? "Contact" : "संपर्क"}</Link>
                  </li>
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/about">{language ? "About" : "के बारे में"}</Link>
                  </li>
                  <li className="text-gray-600 hover:text-blue-600">
                    <Link to="/digital_money">{language ? "Earn Money" : "पैसे कमाएं"}</Link>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link to="/" className="flex items-center">
              ...
              <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">BRVKM & NC</span>
            </Link>
            <div className="flex items-center lg:order-2">
               <button onClick={() => setLanguage(!language)} className="text-black bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">{!language ? "English" : "हिंदी"}</button>
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  <Link to="/" className="block py-2 pr-4 pl-3 text-gray-700 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" aria-current="page"></Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/about" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">{language ? "About" : "के बारे में"}</Link>
                </li>
                <li>
                  <Link to="/digital_money" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">{language ? "Earn Money" : "पैसे कमाएं"}</Link>
                </li>
